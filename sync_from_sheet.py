"""
Planet x Cannabis - Auto Sync from Google Sheets
==========================================
...
a filtered menu for Planet x Cannabis (ALC01).
...
def main():
    print("=" * 60)
    print(f"  Planet x Cannabis - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://theplanetx.ca")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
