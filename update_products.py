"""
Planet x Cannabis — Product Update Script
===================================
Drop your ONHAND CSV into the planet-x folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  Planet x Cannabis — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://theplanetx.ca")
    else:
