...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "metaDescription": "Plan a North York visit to Planet X Cannabis with store-page checks, menu categories, and practical next steps for adults 19+.",
    "meta_description": "Plan a North York visit to Planet X Cannabis with store-page checks, menu categories, and practical next steps for adults 19+.",
  ...
  },
  {
    ...
    "title": "Planet X Cannabis Flower Guide: Budget, Premium and Exotic Sections",
    "seoTitle": "Planet X Cannabis Flower Guide | North York Budget to Exotic",
    "seo_title": "Planet X Cannabis Flower Guide | North York Budget to Exotic",
    "metaDescription": "Compare Planet X Cannabis flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "meta_description": "Compare Planet X Cannabis flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "h1": "Planet X Cannabis Flower Guide: Budget, Premium and Exotic Sections",
    "excerpt": "A clear flower guide for Planet X Cannabis, from cheap weed and budget weed searches to premium flower and exotic flower browsing.",
    "author": "Luna X",
    "authorName": "Luna X",
    "authorHandle": "@LunaAtPlanetX",
    "authorRole": "House Writer",
  ...
  },
  {
    ...
    "title": "Planet X Cannabis Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "seoTitle": "Planet X Cannabis Menu Guide | North York Weed Store Categories",
    "seo_title": "Planet X Cannabis Menu Guide | North York Weed Store Categories",
    "metaDescription": "Use this Planet X Cannabis menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "meta_description": "Use this Planet X Cannabis menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "h1": "Planet X Cannabis Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "excerpt": "A practical North York menu guide for Planet X Cannabis, with natural category paths for adults 19+.",
    "author": "Xavier Nova",
    "authorName": "Xavier Nova",
    "authorHandle": "@XavierPlanetX",
    "authorRole": "House Writer",
