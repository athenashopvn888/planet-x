...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Planet x Cannabis is North York's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=PLX01`)
      .then((r) => r.json())
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Planet x Cannabis <span className={styles.heroAccent}>Blog</span>
          </h1>
