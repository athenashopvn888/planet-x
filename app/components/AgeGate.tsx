...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("PLX01_age_verified");
    if (verified !== "true") {
  ...
  const handleVerify = () => {
    localStorage.setItem("PLX01_age_verified", "true");
    setShow(false);
  };
          ...
          <div className={styles.promptState}>
            <div className={styles.logoWrap}>
              ...
              <img
                ...
                alt="Planet x Cannabis"
                className={styles.logo}
              />
            </div>
            <h2 className={styles.title}>Age Verification</h2>
            <p className={styles.text}>
              Planet x Cannabis requires all visitors to be of legal age.
