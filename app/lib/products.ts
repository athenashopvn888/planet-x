...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse the full cannabis edibles menu at Planet x Cannabis on North York St, North York. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in North York? Planet x Cannabis stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 3005 Islington Ave unit 1 — open daily 24 hours.",
    faqs: [
      ...
      { q: "Can I buy edibles at Planet x Cannabis?", a: "Yes! Visit us at 3005 Islington Ave unit 1, North York. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    ...
    seoIntro: "Shop THC and nicotine vape pens at Planet x Cannabis, North York. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "Planet x Cannabis carries a curated selection of vape pens and cartridges in North York. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 3005 Islington Ave unit 1 for the best vape selection in ByWard Market.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at Planet x Cannabis, North York. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Planet x Cannabis stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 3005 Islington Ave unit 1, North York.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Premium cannabis concentrates at Planet x Cannabis, North York. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "Planet x Cannabis offers a premium selection of cannabis concentrates in North York. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 3005 Islington Ave unit 1.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at Planet x Cannabis, North York. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from Planet x Cannabis in North York. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 3005 Islington Ave unit 1 — open daily 24 hours.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes North York — Discount Tobacco at Planet x Cannabis",
    seoIntro: "Discount native cigarettes at Planet x Cannabis, North York. Premium and value brands at the best prices on North York St.",
    seoDescription: "Planet x Cannabis is your go-to source for affordable native cigarettes in North York. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 3005 Islington Ave unit 1 in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
      { q: "Do you sell cigarettes at Planet x Cannabis?", a: "Yes! We carry a wide selection of native cigarette brands at competitive prices." },
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Planet x Cannabis, North York.",
    seoDescription: "Planet x Cannabis carries a curated selection of magic mushrooms and specialty products in North York. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 3005 Islington Ave unit 1 for our full selection.",
    faqs: [
