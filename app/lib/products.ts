...
export async function fetchLiveProducts(): Promise<{
  ...
  try {
    const res = await fetch(`${APPS_SCRIPT_URL}?store=PLX01`, {
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    color: "#f97316",
    icon: "",
    seoTitle: "Edibles North York | Planet X Cannabis",
    seoIntro:
      "Browse edibles category information at Planet X Cannabis near Islington Avenue and Steeles Avenue West.",
    seoDescription:
      "Review edibles category information for Planet X Cannabis in North York. Confirm current menu details before visiting 3005 Islington Ave unit 1. This page supports browsing and does not promise current product availability.",
    faqs: [
      {
        q: "What edibles information can shoppers review?",
        a: "Customers can review edibles category information and confirm current menu details before visiting Planet X Cannabis.",
      },
      {
  ...
  "VAPE PENS": {
    ...
    seoDescription:
      "Review thc vape category information for Planet X Cannabis in North York. Confirm current menu details before visiting 3005 Islington Ave unit 1. This page supports browsing and does not promise current product availability.",
    faqs: [
      {
  ...
  "VAPE DISPOSABLE": {
    ...
    seoDescription:
      "Review nic vape category information for Planet X Cannabis in North York. Confirm current menu details before visiting 3005 Islington Ave unit 1. This page supports browsing and does not promise current product availability.",
    faqs: [
      {
  ...
  CONCENTRATES: {
    ...
    color: "#f59e0b",
    icon: "",
    seoTitle: "Concentrates North York | Planet X Cannabis",
    seoIntro:
      "Browse concentrates category information at Planet X Cannabis near Islington Avenue and Steeles Avenue West.",
    seoDescription:
      "Review concentrates category information for Planet X Cannabis in North York. Confirm current menu details before visiting 3005 Islington Ave unit 1. This page supports browsing and does not promise current product availability.",
    faqs: [
      {
        q: "What concentrates information can shoppers review?",
        a: "Customers can review concentrates category information and confirm current menu details before visiting Planet X Cannabis.",
      },
      {
        q: "Does this page guarantee current availability?",
        a: "No. Category details can change, so customers should confirm the current menu before visiting.",
  ...
  PREROLLS: {
    ...
    color: "#22c55e",
    icon: "",
    seoTitle: "Pre-Rolls North York | Planet X Cannabis",
    seoIntro:
      "Browse pre-rolls category information at Planet X Cannabis near Islington Avenue and Steeles Avenue West.",
    seoDescription:
      "Review pre-rolls category information for Planet X Cannabis in North York. Confirm current menu details before visiting 3005 Islington Ave unit 1. This page supports browsing and does not promise current product availability.",
    faqs: [
      {
        q: "What pre-rolls information can shoppers review?",
        a: "Customers can review pre-rolls category information and confirm current menu details before visiting Planet X Cannabis.",
      },
      {
        q: "Does this page guarantee current availability?",
        a: "No. Category details can change, so customers should confirm the current menu before visiting.",
  ...
  "ADD ONS": {
    ...
    color: "#34d399",
    icon: "",
    seoTitle: "Accessories North York | Planet X Cannabis",
    seoIntro:
      "Browse accessories category information at Planet X Cannabis near Islington Avenue and Steeles Avenue West.",
    seoDescription:
      "Review accessories category information for Planet X Cannabis in North York. Confirm current menu details before visiting 3005 Islington Ave unit 1. This page supports browsing and does not promise current product availability.",
    faqs: [
      {
        q: "What accessories information can shoppers review?",
        a: "Customers can review accessories category information and confirm current menu details before visiting Planet X Cannabis.",
      },
      {
        q: "Does this page guarantee current availability?",
        a: "No. Category details can change, so customers should confirm the current menu before visiting.",
  ...
  "MAGIC & OTHERS": {
    ...
    color: "#64748b",
    icon: "",
    seoTitle: "Magic Stuff North York | Planet X Cannabis",
    seoIntro:
      "Browse magic stuff category information at Planet X Cannabis near Islington Avenue and Steeles Avenue West.",
    seoDescription:
      "Review magic stuff category information for Planet X Cannabis in North York. Confirm current menu details before visiting 3005 Islington Ave unit 1. This page supports browsing and does not promise current product availability.",
    faqs: [
      {
        q: "What magic stuff information can shoppers review?",
        a: "Customers can review magic stuff category information and confirm current menu details before visiting Planet X Cannabis.",
      },
      {
        q: "Does this page guarantee current availability?",
        a: "No. Category details can change, so customers should confirm the current menu before visiting.",
  ...
  CIGARETTES: {
    ...
    color: "#78716c",
    icon: "",
    seoTitle: "Cigarettes North York | Planet X Cannabis",
    seoIntro:
      "Browse cigarettes category information at Planet X Cannabis near Islington Avenue and Steeles Avenue West.",
    seoDescription:
      "Review cigarettes category information for Planet X Cannabis in North York. Confirm current menu details before visiting 3005 Islington Ave unit 1. This page supports browsing and does not promise current product availability.",
    faqs: [
      {
        q: "What cigarettes information can shoppers review?",
        a: "Customers can review cigarettes category information and confirm current menu details before visiting Planet X Cannabis.",
      },
      {
        q: "Does this page guarantee current availability?",
        a: "No. Category details can change, so customers should confirm the current menu before visiting.",
