...
export const weedOwner = {
  ...
  discoveryLinks: [
    { label: "Exotic Flower", description: "Explore the verified Exotic flower section.", href: "/exotic-weed" },
    { label: "Premium Flower", description: "Explore the verified Premium flower section.", href: "/premium-weed" },
    ...
    { label: "Value Guide", description: "Explore value-oriented cannabis shopping without current-price claims.", href: "/resources/weed-value-guide" },
