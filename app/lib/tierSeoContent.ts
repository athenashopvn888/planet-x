    ...
    sections: [
      {
        ...
        body: "Planet X Cannabis lists Exotic flower as part of its tiered cannabis menu. Use this page for category context, then check the current menu for exact strain availability, THC details, and package pricing.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "Planet X Cannabis lists Premium flower as part of its tiered cannabis menu. Use this page for category context, then check the current menu for exact strain availability, THC details, and package pricing.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "Planet X Cannabis lists AAA+ flower as part of its tiered cannabis menu. Use this page for category context, then check the current menu for exact strain availability, THC details, and package pricing.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "Planet X Cannabis lists AA flower as part of its tiered cannabis menu. Use this page for category context, then check the current menu for exact strain availability, THC details, and package pricing.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "Planet X Cannabis lists Budget flower as part of its tiered cannabis menu. Use this page for category context, then check the current menu for exact strain availability, THC details, and package pricing.",
      },
      {
