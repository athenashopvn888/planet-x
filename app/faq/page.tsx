...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about Planet x Cannabis in North York. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Planet x Cannabis located?", a: "We are located at 3005 Islington Ave unit 1, North York, ON M9L 2K9. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      ...
      { q: "What's the best way to get to Planet x Cannabis?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at theplanetx.ca updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! Planet x Cannabis is walk-in only. Just show up anytime — we're open Open 24 Hours." },
      { q: "Can I order online?", a: "Currently, Planet x Cannabis is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
          <img
            ...
            alt="Planet x Cannabis FAQ — Your Questions Answered"
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about Planet x Cannabis — North York&apos;s premium dispensary at 3005 Islington Ave unit 1 in North York.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call us at <strong>(226) 545-3005</strong> or visit us at 3005 Islington Ave unit 1, North York.
            </p>
          </div>
        </div>
        <Footer />
