    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          Planet x Cannabis is launching delivery across North York.
        ...
        <div className={styles.ctaSection}>
          <p className={styles.ctaText}>
            Can&apos;t wait? Visit us in-store at <strong>3005 Islington Ave unit 1, North York</strong> —
            open <strong>24 hours</strong>. Call <strong>(226) 545-3005</strong>.
          </p>
        </div>
      </div>
      <Footer />
