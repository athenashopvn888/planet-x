...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Planet X" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="PLX01" />
      <input type="hidden" name="StoreName" value="Planet X Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Planet X Cannabis?</span>
      ...
      <div className={styles.formSection}>
        ...
        <fieldset className={styles.choiceGroup}>
          <legend>Can you reliably get to North York for scheduled shifts?</legend>
